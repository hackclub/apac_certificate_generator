  ...
  blocks: [
    {
      ...
      text: {
        type: 'mrkdwn',
        text: `*Hey <@${user_id}>!* Thanks for signing the certificate, I will make sure that it is delivered to <@${person_to_recieve}> and will also notify <@U010XUNLX40> that you signed the certificate!`,
      },
    },
  ],
});
